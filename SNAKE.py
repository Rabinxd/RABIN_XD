...
def contact():
	...
	os.system('xdg-open https://www.facebook.com/profile.php?id=100073740726893')
...
\033[1;32m----------------------------------------------
➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃RABIN⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤
❣︎[𖣘]☔︎CREATED BY   :  RABIN_XD
❣︎[𖣘]☔︎ FB NAME     : SELLER  ANURAG
❣︎[𖣘]☔︎ON GITHUB    :  RABIN_XD
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[RABIN]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
